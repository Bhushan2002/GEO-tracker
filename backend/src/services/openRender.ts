...
export const extractBrandFromText  = async (textToAnalyze :string)=>{
...
For Direct Use: Copy-paste the entire block into ChatGPT/Claude/Perplexity, fill in the [INSERT LIST] and ${textToAnalyze} brackets, and it will return a clean JSON object ready for your database or spreadsheet.
  `;
  try{
