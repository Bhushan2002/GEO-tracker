...
export default function PromptDetailsPage({ manualId }: { manualId?: string }) {
    ...
    if (loading) return (
        <div className="p-8 min-h-screen bg-white space-y-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                <Skeleton className="xl:col-span-5 h-[400px] w-full rounded-xl" />
                <Skeleton className="xl:col-span-7 h-[400px] w-full rounded-xl" />
            </div>
            <Skeleton className="h-[400px] w-full rounded-xl" />
        </div>
    );
