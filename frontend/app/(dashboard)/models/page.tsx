        ...
        <div className="min-h-screen bg-white text-slate-900 animate-in fade-in duration-500 ease-out">
            <div className="max-w-[1600px] mx-auto px-6 py-6 space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="bg-slate-100 p-1.5 rounded-xl flex items-center gap-1 overflow-x-auto no-scrollbar max-w-full">
                        {MODELS.map((model) => (
                            <button
                                key={model}
                                onClick={() => setSelectedModel(model)}
                                className={cn(
                                    "px-4 py-2 text-[13px] font-bold rounded-lg transition-all duration-300 min-w-[80px] flex-shrink-0",
                                    selectedModel === model
